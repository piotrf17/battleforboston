...
urlpatterns = patterns('',
  ...
  url(r'^payments/(?P<payment_id>\d+)$', views.payment_detail,
      name='payment_detail'),
  url(r'^payments/(?P<payment_id>\d+)/receipt$', views.payment_receipt,
  ...
  url(r'^events/(?P<event_id>\d+)/reset', views.event_reset, name='event_reset'),
  url(r'^events/(?P<event_id>\d+)/bracket', views.event_bracket,
      name='event_bracket'),
  url(r'^events/(?P<event_id>\d+)/winners', views.event_winners,
      name='event_winners'),
  # Team events.
  ...
  url(r'^team_events/(?P<event_id>\d+)/reset', views.event_reset_team,
      name='event_reset_team'),
)
